...
- 🇫🇷 **Variables traduites en français** (métropole et Outre-Mer)
- 🎯 **Listes recentrées sur les variables les plus utiles** (températures, vent, humidité, précipitations, pression, nébulosité, orages : CAPE/CIN, grêle) — case *« Afficher toutes les variables »* pour la liste complète
- 🌡➡️ **Conversion automatique des unités** à l'import : Kelvin → °C, Pa → hPa, m/s → km/h, kg/m² → mm…
- ✂️ **Extraction du raster selon l'emprise d'une couche vectorielle** (ou du canevas)
